...
When you run a home server, like a Synology NAS or a mini-PC with Docker, you usually want to access your services using a proper domain name and valid SSL certificates, both from home WiFi and from the outside.
...
- When you are connected to your home WiFi, MikroTik DNS answers the query and gives the local LAN IP (like 192.168.88.2) directly.

How to set this up in RouterOS:

1. In Winbox, go to IP -> DNS -> Static.
