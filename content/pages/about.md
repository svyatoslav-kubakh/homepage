...
* **iGaming & Real-Time Game Engines:** Designing core game server architectures with complex mechanics (RNG, RTP calculations, reel/symbol generation, crash algorithms, game state machines) at [ELA Games](https://www.elagames.com/) (BrainRocket ecosystem).
* **Distributed Systems & Microservices:** Building low-latency backend services using **Node.js / TypeScript** (NestJS, Express) and **PHP** (Symfony, Laravel), powered by **WebSockets**, **Redis**, and **MySQL**.
...
This space is where I share architectural insights, lessons learned from highload production environments, backend engineering practices, and practical explorations of AI-assisted software development.
